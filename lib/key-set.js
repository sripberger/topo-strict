...
/**
 * Helper function for KeySet#splitArgs. Used to identify whether an argument
 * should be treated as an id or array of ids preceding the options object.
 * @private
 * @param {any} arg - Argument to check.
 * @returns {boolean} - `true` if `arg` should be treated as an ids arg, `false`
 *   otherwise.
 */
